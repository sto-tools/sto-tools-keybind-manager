...
export class KBFParser {
   ...
   * @param {{ targetEnvironment?: string, includeMetadata?: boolean }} [options] - Parsing options
 ...
 * @param {{ eventBus?: typeof eventBus, [option: string]: any }} [options] - Configuration options
