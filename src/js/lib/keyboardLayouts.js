...
const KEY_POSITIONS = {
  ...
  Ldrag: { row: 1, col: 22, width: 1 },
  Mdrag: { row: 1, col: 23, width: 1 },
  Rdrag: { row: 1, col: 24, width: 1 },
  Ldblclick: { row: 2, col: 22, width: 1 },
  Mdblclick: { row: 2, col: 23, width: 1 },
  Rdblclick: { row: 2, col: 24, width: 1 },
  ...
  Wheelplus: { row: 5, col: 23, width: 1 },
  Wheelminus: { row: 5, col: 24, width: 1 },
}
...
const MOUSE_GESTURES = {
  ...
  ldblclick: { name: 'Left Double Click', description: 'Double left mouse click' },
  rdblclick: { name: 'Right Double Click', description: 'Double right mouse click' },
  mdblclick: { name: 'Middle Double Click', description: 'Double middle mouse click' },
