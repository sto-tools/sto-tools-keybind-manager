...
// @ts-expect-error Bind-to-alias names are generated by the direct canonical helper.
...
async function exerciseCoreApi() {
  ...
  // @ts-expect-error Alias names are generated directly without request/response.
  request(eventBus, "command-chain:generate-alias-name", {
    environment: "space",
    keyName: "F1",
  });
  // @ts-expect-error Alias previews are formatted directly without request/response.
  request(eventBus, "command-chain:generate-alias-preview", {
