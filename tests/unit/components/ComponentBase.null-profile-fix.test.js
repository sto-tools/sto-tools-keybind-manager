  ...
  describe("profile:updated handler with null profile", () => {
    it("should handle null profile without throwing errors", () => {
      ...
      componentBase.cache.aliases = {
        testAlias: { commands: ["TestCommand"] },
      };
      ...
      expect(() => {
        ...
        const handler = ({ profileId, profile }) => {
          if (
            componentBase.cache &&
            profileId === componentBase.cache.currentProfile
          ) {
            ...
            if (profile.builds) {
              ...
              const currentBuild =
                profile.builds[componentBase.cache.currentEnvironment];
    ...
    it("should handle null profile without throwing errors", () => {
      ...
      expect(() => {
        ...
        const handler = ({ profileId, profile, environment }) => {
          ...
          componentBase._currentEnvironment =
            componentBase.cache.currentEnvironment;
