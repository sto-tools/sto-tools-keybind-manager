...
describe("CommandService Bindset-Aware Key Validation", () => {
  ...
  beforeEach(async () => {
    ...
    const CommandService = (
      await import("../../../src/js/components/services/CommandService.js")
    ).default;
  ...
  describe("validateKeyExistsInCurrentContext", () => {
    ...
    it("should return false for keys that do not exist anywhere", () => {
      ...
      const exists =
        commandService.validateKeyExistsInCurrentContext("NonExistent");
    ...
    it("should return true for keys that exist in active bindset when no active bindset is set", () => {
      ...
      const existsInPrimary =
        commandService.validateKeyExistsInCurrentContext("F1");
      const existsInBindsetOnly =
        commandService.validateKeyExistsInCurrentContext("F3");
    ...
    it("should return true for keys that exist in primary bindset even when active bindset is set", () => {
      ...
      const existsInPrimaryOnly =
        commandService.validateKeyExistsInCurrentContext("F2");
    ...
    it("should return false for empty or null key names", () => {
      ...
      expect(commandService.validateKeyExistsInCurrentContext(null)).toBe(
        false,
      );
      expect(commandService.validateKeyExistsInCurrentContext(undefined)).toBe(
        false,
      );
    });
  });
